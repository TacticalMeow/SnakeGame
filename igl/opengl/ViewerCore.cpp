  ...
  bool update_matrices)
{
  ...
  //cubemap
  if (data.meshgl.is_cubemap)
  {
      viewi = glGetUniformLocation(data.meshgl.shader_skybox, "view");
      proji = glGetUniformLocation(data.meshgl.shader_skybox, "proj");
      glUniformMatrix4fv(viewi, 1, GL_FALSE, view.data());
      glUniformMatrix4fv(proji, 1, GL_FALSE, proj.data());
  }
