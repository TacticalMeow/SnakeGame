...
public:
  ...
  //Cubemap support - Eden Mansdorf
  bool load_texture_as_cubemap(const std::string& textures_directory);
  ...
  //Custom stuff for snake game support.
  igl::AABB<Eigen::MatrixXd, 3> tree;
  igl::AABB<Eigen::MatrixXd, 3> lastTree;
  Eigen::MatrixXi E;
  IGL_INLINE void buildBox();
  Eigen::Vector3d moving_direction;
