...
namespace glfw
{
  ...
  public:
   ...
   // enum class MouseMode { None, Rotation, Zoom, Pan, Translation} mouse_mode;
    ...
    IGL_INLINE int load_cubemap_from_file(const std::string& cube_obj_filename, const std::string& texture_filename);
   ...
   // IGL_INLINE void draw();
    ...
    //stuff for the game project - Eden Mansdorf

    void Init_fp_pov(const int object_id);
    Eigen::Vector3f Get_FPView();
    Eigen::Matrix3f GetSnakeRotation();
...
public:
    ...
    int pov_mesh_index = -1;
    Eigen::Vector3f pov_camera_direction;
    Eigen::Vector3f pov_original_location; //the eye location before translation/rotation.
